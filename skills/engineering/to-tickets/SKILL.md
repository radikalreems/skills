...
The issue tracker and triage label vocabulary should have been provided to you. If they aren't already in context, read `docs/agents/issue-tracker.md` and `docs/agents/triage-labels.md`. If those files aren't there, tell the user to run `/setup-workflow`.
