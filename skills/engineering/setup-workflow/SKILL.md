---
name: setup-workflow
description: Configure this repo's issue tracker, triage labels, and domain docs. Run once before the other engineering skills.
...
Record the layout in `docs/agents/domain.md`.
...
- [single-domain.md](./single-domain.md): single-context domain docs
- [multi-domain.md](./multi-domain.md): multi-context domain docs

Copy the matching issue-tracker seed to `docs/agents/issue-tracker.md` and the matching domain seed to `docs/agents/domain.md`.
